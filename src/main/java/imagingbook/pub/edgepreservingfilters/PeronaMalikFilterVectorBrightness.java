 ...
 * @version 2020/01/02
 */
public class PeronaMalikFilterVectorBrightness extends GenericFilterVector {
...
//	private final float alpha;
	...
	public PeronaMalikFilterVectorBrightness (ImageProcessor ip) {
		this(ip, new Parameters());
	}
	
	// constructor - use this version to set all parameters
	public PeronaMalikFilterVectorBrightness (ImageProcessor ip, Parameters params) {
		super(ip, params.obs);
		this.params = params;
...
//				//fm = new FilterColorSeparate(); 
//				break;
//			case BrightnessGradient : 	
//				//fm = new FilterColorBrightnessGradient(); 
//				break;
//			case ColorGradient : 	  	
//				fm = new FilterColorColorGradient(); 
//				break;
//			}
//		}
//		else {
