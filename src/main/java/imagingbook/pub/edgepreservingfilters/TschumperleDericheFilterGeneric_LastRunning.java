...
public class TschumperleDericheFilterGeneric_LastRunning extends GenericFilter {
...
//	private float initial_min;
	...
	public TschumperleDericheFilterGeneric_LastRunning(ImageProcessor ip) {
		this(new Parameters());
	}
	
	// constructor - use for setting individual parameters:
	public TschumperleDericheFilterGeneric_LastRunning(Parameters params) {
		this.params = params;
