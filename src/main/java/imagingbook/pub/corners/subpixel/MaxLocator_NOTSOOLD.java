 ...
 * @version 2020/10/03
 */
public abstract class MaxLocator_NOTSOOLD {
	...
	/**
	 * Enumeration of keys for {@link MaxLocator_NOTSOOLD} methods.
	 */
	public enum Method {
	...
	/**
	 * Creates a specific {@link MaxLocator_NOTSOOLD} instance based on the supplied
	 * {@link Method} key.
	 * @param m the method
	 * @return a new {@link MaxLocator_NOTSOOLD} instance
	 */
	public static MaxLocator_NOTSOOLD getInstance(Method m) {
		MaxLocator_NOTSOOLD ml = null;
		switch(m) {
	 ...
	 * @see MaxLocator_NOTSOOLD#getMax(float[])
	 */
	public static class QuadraticTaylor extends MaxLocator_NOTSOOLD {
	 ...
	 * @see MaxLocator_NOTSOOLD#getMax(float[])
	 */
	public static class QuadraticLeastSquares extends MaxLocator_NOTSOOLD {
	 ...
	 * @see MaxLocator_NOTSOOLD#getMax(float[])
	 */
	public static class Quartic extends MaxLocator_NOTSOOLD {
